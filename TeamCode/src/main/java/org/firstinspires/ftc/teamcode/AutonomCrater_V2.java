...
//            if()
        ...
        while (!isStopRequested() && mineralSum < 2 && tfod != null) {
            ...
            if ((mineralRetrievalTimer.milliseconds() >= 2000 || firstRecognitionCheck) && recognitionPosition == 2) {
                robot.gyroRotationWIP(firstRecognition, "absolute", side);
                recognitionPosition = 1;
                ...
                for (Recognition recognition : updatedRecognitions) {
                    ...
                    if (Math.abs(recognition.getWidth() / recognition.getHeight() - 1) < 0.35) {
                        ...
                        if (recognition.getLabel().equals(LABEL_GOLD_MINERAL)) {
                            ...
                            for (int i = 1; i <= 3; i++) {
                                if (extremecoordinatesMinerals[0][i] == 0) {
                                    ...
                                    extremecoordinatesMinerals[1][i] = robot.globalGyroValue(side) + 270 + supportAngle;
                        ...
                        if (recognition.getLabel().equals(LABEL_SILVER_MINERAL)) {
                            ...
                            robotSphereAngle = robot.mathModulo(robot.globalGyroValue(side) + 270 + supportAngle, 360);
                            ...
                            for (int i = 1; i <= 3; i++) {
                                if (extremecoordinatesMinerals[0][i] != 0) {
                                    if (extremecoordinatesMinerals[3][i] < 100 && side.equals("Crater")) {
                                        extremecoordinatesMinerals[3][i] = 350;
                                    }
                                    if (extremecoordinatesMinerals[3][i] > 300 && side.equals("Depot")) {
                                        extremecoordinatesMinerals[3][i] = 10;
                                    }
...
//            robot.setDrivetrainPosition(-hittingMineralDistance, "translation", 1.0);
    ...
    //auxiliary functions
    int gyroValue() {
        return robot.globalGyroValue(side);
    }
...
//                 }
        ...
        while (currentError > 62 && !robot.opMode.isStopRequested()) {
            currentDriveTrainPosition = robot.driveFrontLeft.getCurrentPosition();
...
//                 }
    ...
    void tensorDetectionSimple(int[] mineralSequence) {
...
//            if()
        ...
        while (!isStopRequested() && mineralSum < 2 && tfod != null) {
            ...
            if (mineralRetrievalTimer.milliseconds() >= 2000 && recognitionPosition == 2) {
                robot.gyroRotationWIP(firstRecognition, "absolute", side);
                recognitionPosition = 1;
                mineralRetrievalTimer.reset();
            } else if (mineralRetrievalTimer.milliseconds() >= 2000 && recognitionPosition == 1) {
                robot.gyroRotationWIP(secondRecognition, "absolute", side);
                recognitionPosition = 2;
                mineralRetrievalTimer.reset();
            }
                ...
                for (Recognition recognition : updatedRecognitions) {
                    ...
                    if (Math.abs(recognition.getWidth() / recognition.getHeight() - 1) < 0.35) {
                        ...
                        if (recognition.getLabel().equals(LABEL_GOLD_MINERAL)) {
                            ...
                            if (goldMineralX >= 270) {
                                mineralSequence[recognitionPosition + 1] = 2;
                            } else if (goldMineralX < 270) {
                                mineralSequence[recognitionPosition] = 2;
                            }
                        ...
                        if (recognition.getLabel().equals(LABEL_SILVER_MINERAL)) {
                            ...
                            if (silverMineralX >= 270) {
                                mineralSequence[recognitionPosition + 1] = 1;
                            } else if (silverMineralX < 270) {
                                mineralSequence[recognitionPosition] = 1;
                            }
                        }
